...
const namePrefix = "X-Launcher Origins";
const description = "The origins of a X-Launcher Launchpad Platform built on Elrond Blockchain where the future projects will be launched.";
